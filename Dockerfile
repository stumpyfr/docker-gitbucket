...
ENV WARURL https://github.com/takezoe/gitbucket/releases/download/2.8/gitbucket.war
ENV USER gitbucket
...
CMD    /usr/sbin/sshd && java -jar /home/$USER/gitbucket/gitbucket.war --port 8080  --host 0.0.0.0 --gitbucket.home=/data